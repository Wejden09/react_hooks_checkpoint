    ...
    return(
      ...
      <header className="bg-blue-600 text-white py-6 mb-8">
       ...
       <div id='center' className="container mx-auto px-4">
        <button id='filters' onClick={() => setShow(!show)} className="bg-blue-500 text-white px-4 py-2 rounded-md">Add Movie</button>
        {show?<AddMovieForm onAdd={handelAdd} /> : null}
 <button  onClick={() => setShowFilter(!showFilter)} className="bg-blue-500 text-white px-4 py-2 rounded-md">Filter Movie</button>
